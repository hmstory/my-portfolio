 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vt(i,e){const t={typeString:i};return e&&(t.value=e),t}function Ja(i,e){if(!u_(i))throw new te($.INVALID_ARGUMENT,"JSON must be an object");let t;for(const s in e)if(e[s]){const o=e[s].typeString,u="value"in e[s]?{value:e[s].value}:void 0;if(!(s in i)){t=`JSON missing required field: '${s}'`;break}const h=i[s];if(o&&typeof h!==o){t=`JSON field '${s}' must be a ${o}.`;break}if(u!==void 0&&h!==u.value){t=`Expected '${s}' field to equal '${u.value}'`;break}}if(t)throw new te($.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Po(i){if(i.code!==$.FAILED_PRECONDITION||i.message!==MT)throw i;ie("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $t="WebChannelConnection";class R1 extends A1{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,s,o,u){const h=Fd();return new Promise(((m,y)=>{const _=new t_;_.setWithCredentials(!0),_.listenOnce(n_.COMPLETE,(()=>{try{switch(_.getLastErrorCode()){case Lu.NO_ERROR:const C=_.getResponseJson();ie($t,`XHR for RPC '${e}' ${h} received:`,JSON.stringify(C)),m(C);break;case Lu.TIMEOUT:ie($t,`RPC '${e}' ${h} timed out`),y(new te($.DEADLINE_EXCEEDED,"Request time out"));break;case Lu.HTTP_ERROR:const D=_.getStatus();if(ie($t,`RPC '${e}' ${h} failed with status:`,D,"response text:",_.getResponseText()),D>0){let z=_.getResponseJson();Array.isArray(z)&&(z=z[0]);const J=z==null?void 0:z.error;if(J&&J.status&&J.message){const Y=(function(we){const pe=we.toLowerCase().replace(/_/g,"-");return Object.values($).indexOf(pe)>=0?pe:$.UNKNOWN})(J.status);y(new te(Y,J.message))}else y(new te($.UNKNOWN,"Server responded with status "+_.getStatus()))}else y(new te($.UNAVAILABLE,"Connection failed."));break;default:ge(9055,{l_:e,streamId:h,h_:_.getLastErrorCode(),P_:_.getLastError()})}}finally{ie($t,`RPC '${e}' ${h} completed.`)}}));const w=JSON.stringify(o);ie($t,`RPC '${e}' ${h} sending request:`,o),_.send(t,"POST",w,s,15)}))}T_(e,t,s){const o=Fd(),u=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],h=s_(),m=i_(),y={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},_=this.longPollingOptions.timeoutSeconds;_!==void 0&&(y.longPollingTimeout=Math.round(1e3*_)),this.useFetchStreams&&(y.useFetchStreams=!0),this.jo(y.initMessageHeaders,t,s),y.encodeInitMessageHeaders=!0;const w=u.join("");ie($t,`Creating RPC '${e}' stream ${o}: ${w}`,y);const C=h.createWebChannel(w,y);this.I_(C);let D=!1,z=!1;const J=new C1({Yo:q=>{z?ie($t,`Not sending because RPC '${e}' stream ${o} is closed:`,q):(D||(ie($t,`Opening RPC '${e}' stream ${o} transport.`),C.open(),D=!0),ie($t,`RPC '${e}' stream ${o} sending:`,q),C.send(q))},Zo:()=>C.close()}),Y=(q,we,pe)=>{q.listen(we,(Ee=>{try{pe(Ee)}catch(Pe){setTimeout((()=>{throw Pe}),0)}}))};return Y(C,Na.EventType.OPEN,(()=>{z||(ie($t,`RPC '${e}' stream ${o} transport opened.`),J.o_())})),Y(C,Na.EventType.CLOSE,(()=>{z||(z=!0,ie($t,`RPC '${e}' stream ${o} transport closed`),J.a_(),this.E_(C))})),Y(C,Na.EventType.ERROR,(q=>{z||(z=!0,vo($t,`RPC '${e}' stream ${o} transport errored. Name:`,q.name,"Message:",q.message),J.a_(new te($.UNAVAILABLE,"The operation could not be completed")))})),Y(C,Na.EventType.MESSAGE,(q=>{var we;if(!z){const pe=q.data[0];qe(!!pe,16349);const Ee=pe,Pe=(Ee==null?void 0:Ee.error)||((we=Ee[0])==null?void 0:we.error);if(Pe){ie($t,`RPC '${e}' stream ${o} received error:`,Pe);const Ge=Pe.status;let xe=(function(R){const k=yt[R];if(k!==void 0)return U_(k)})(Ge),N=Pe.message;xe===void 0&&(xe=$.INTERNAL,N="Unknown error status: "+Ge+" with message "+Pe.message),z=!0,J.a_(new te(xe,N)),C.close()}else ie($t,`RPC '${e}' stream ${o} received:`,pe),J.u_(pe)}})),Y(m,r_.STAT_EVENT,(q=>{q.stat===Ad.PROXY?ie($t,`RPC '${e}' stream ${o} detected buffering proxy`):q.stat===Ad.NOPROXY&&ie($t,`RPC '${e}' stream ${o} detected no buffering proxy`)})),setTimeout((()=>{J.__()}),0),J}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((t=>t===e))}}function md(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tn{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Tn(Mt.fromBase64String(e))}catch(t){throw new te($.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Tn(Mt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:Tn._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(Ja(e,Tn._jsonSchema))return Tn.fromBase64String(e.bytes)}}Tn._jsonSchemaVersion="firestore/bytes/1.0",Tn._jsonSchema={type:vt("string",Tn._jsonSchemaVersion),bytes:vt("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ac{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new te($.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Lt(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sr{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new te($.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new te($.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Oe(this._lat,e._lat)||Oe(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:sr._jsonSchemaVersion}}static fromJSON(e){if(Ja(e,sr._jsonSchema))return new sr(e.latitude,e.longitude)}}sr._jsonSchemaVersion="firestore/geoPoint/1.0",sr._jsonSchema={type:vt("string",sr._jsonSchemaVersion),latitude:vt("number"),longitude:vt("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class or{constructor(e){this._values=(e||[]).map((t=>t))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(s,o){if(s.length!==o.length)return!1;for(let u=0;u<s.length;++u)if(s[u]!==o[u])return!1;return!0})(this._values,e._values)}toJSON(){return{type:or._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(Ja(e,or._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((t=>typeof t=="number")))return new or(e.vectorValues);throw new te($.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}or._jsonSchemaVersion="firestore/vectorValue/1.0",or._jsonSchema={type:vt("string",or._jsonSchemaVersion),vectorValues:vt("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
