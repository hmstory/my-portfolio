 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Mw=Ye.forwardRef(({color:i="currentColor",size:e=24,strokeWidth:t=2,absoluteStrokeWidth:s,className:o="",children:u,iconNode:h,...m},y)=>Ye.createElement("svg",{ref:y,...Lw,width:e,height:e,stroke:i,strokeWidth:s?Number(t)*24/Number(e):t,className:$y("lucide",o),...m},[...h.map(([_,E])=>Ye.createElement(_,E)),...Array.isArray(u)?u:[u]]));/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tI{constructor(e,t,s,o,u,h,m,y,_,E){this.databaseId=e,this.appId=t,this.persistenceKey=s,this.host=o,this.ssl=u,this.forceLongPolling=h,this.autoDetectLongPolling=m,this.longPollingOptions=y,this.useFetchStreams=_,this.isUsingEmulator=E}}const Xu="(default)";class Ka{constructor(e,t){this.projectId=e,this.database=t||Xu}static empty(){return new Ka("","")}get isDefaultDatabase(){return this.database===Xu}isEqual(e){return e instanceof Ka&&e.projectId===this.projectId&&e.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class f1{constructor(e,t,s,o){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=s,this.indexManager=o}getDocument(e,t){let s=null;return this.documentOverlayCache.getOverlay(e,t).next((o=>(s=o,this.remoteDocumentCache.getEntry(e,t)))).next((o=>(s!==null&&$a(s.mutation,o,gn.empty(),nt.now()),o)))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next((s=>this.getLocalViewOfDocuments(e,s,Me()).next((()=>s))))}getLocalViewOfDocuments(e,t,s=Me()){const o=fs();return this.populateOverlays(e,o,t).next((()=>this.computeViews(e,t,o,s).next((u=>{let h=La();return u.forEach(((m,y)=>{h=h.insert(m,y.overlayedDocument)})),h}))))}getOverlayedDocuments(e,t){const s=fs();return this.populateOverlays(e,s,t).next((()=>this.computeViews(e,t,s,Me())))}populateOverlays(e,t,s){const o=[];return s.forEach((u=>{t.has(u)||o.push(u)})),this.documentOverlayCache.getOverlays(e,o).next((u=>{u.forEach(((h,m)=>{t.set(h,m)}))}))}computeViews(e,t,s,o){let u=Ur();const h=Ba(),m=(function(){return Ba()})();return t.forEach(((y,_)=>{const E=s.get(_.key);o.has(_.key)&&(E===void 0||E.mutation instanceof Mi)?u=u.insert(_.key,_):E!==void 0?(h.set(_.key,E.mutation.getFieldMask()),$a(E.mutation,_,E.mutation.getFieldMask(),nt.now())):h.set(_.key,gn.empty())})),this.recalculateAndSaveOverlays(e,u).next((y=>(y.forEach(((_,E)=>h.set(_,E))),t.forEach(((_,E)=>m.set(_,new d1(E,h.get(_)??null)))),m)))}recalculateAndSaveOverlays(e,t){const s=Ba();let o=new at(((h,m)=>h-m)),u=Me();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next((h=>{for(const m of h)m.keys().forEach((y=>{const _=t.get(y);if(_===null)return;let E=s.get(y)||gn.empty();E=m.applyToLocalView(_,E),s.set(y,E);const C=(o.get(m.batchId)||Me()).add(y);o=o.insert(m.batchId,C)}))})).next((()=>{const h=[],m=o.getReverseIterator();for(;m.hasNext();){const y=m.getNext(),_=y.key,E=y.value,C=O_();E.forEach((x=>{if(!u.has(x)){const z=z_(t.get(x),s.get(x));z!==null&&C.set(x,z),u=u.add(x)}})),h.push(this.documentOverlayCache.saveOverlays(e,_,C))}return q.waitFor(h)})).next((()=>s))}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next((s=>this.recalculateAndSaveOverlays(e,s)))}getDocumentsMatchingQuery(e,t,s,o){return(function(h){return de.isDocumentKey(h.path)&&h.collectionGroup===null&&h.filters.length===0})(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):P_(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,s,o):this.getDocumentsMatchingCollectionQuery(e,t,s,o)}getNextDocuments(e,t,s,o){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,s,o).next((u=>{const h=o-u.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,s.largestBatchId,o-u.size):q.resolve(fs());let m=Wa,y=u;return h.next((_=>q.forEach(_,((E,C)=>(m<C.largestBatchId&&(m=C.largestBatchId),u.get(E)?q.resolve():this.remoteDocumentCache.getEntry(e,E).next((x=>{y=y.insert(E,x)}))))).next((()=>this.populateOverlays(e,_,u))).next((()=>this.computeViews(e,y,_,Me()))).next((E=>({batchId:m,changes:b_(E)})))))}))}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new de(t)).next((s=>{let o=La();return s.isFoundDocument()&&(o=o.insert(s.key,s)),o}))}getDocumentsMatchingCollectionGroupQuery(e,t,s,o){const u=t.collectionGroup;let h=La();return this.indexManager.getCollectionParents(e,u).next((m=>q.forEach(m,(y=>{const _=(function(C,x){return new Lo(x,null,C.explicitOrderBy.slice(),C.filters.slice(),C.limit,C.limitType,C.startAt,C.endAt)})(t,y.child(u));return this.getDocumentsMatchingCollectionQuery(e,_,s,o).next((E=>{E.forEach(((C,x)=>{h=h.insert(C,x)}))}))})).next((()=>h))))}getDocumentsMatchingCollectionQuery(e,t,s,o){let u;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,s.largestBatchId).next((h=>(u=h,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,s,u,o)))).next((h=>{u.forEach(((y,_)=>{const E=_.getKey();h.get(E)===null&&(h=h.insert(E,Wt.newInvalidDocument(E)))}));let m=La();return h.forEach(((y,_)=>{const E=u.get(y);E!==void 0&&$a(E.mutation,_,gn.empty(),nt.now()),vc(t,_)&&(m=m.insert(y,_))})),m}))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kA(i,e){const t=Zd(i,"auth");if(t.isInitialized()){const o=t.getImmediate(),u=t.getOptions();if(ms(u,e??{}))return o;Bn(o,"already-initialized")}return t.initialize({options:e})}function xA(i,e){const t=(e==null?void 0:e.persistence)||[],s=(Array.isArray(t)?t:[t]).map(Lr);e!=null&&e.errorMap&&i._updateErrorMap(e.errorMap),i._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function PA(i,e,t){const s=jo(i);ye(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const o=!1,u=r0(e),{host:h,port:m}=NA(e),y=m===null?"":`:${m}`,_={url:`${u}//${h}${y}/`},E=Object.freeze({host:h,port:m,protocol:u.replace(":",""),options:Object.freeze({disableWarnings:o})});if(!s._canInitEmulator){ye(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),ye(ms(_,s.config.emulator)&&ms(E,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=_,s.emulatorConfig=E,s.settings.appVerificationDisabledForTesting=!0,No(h)?(Yy(`${u}//${h}${y}`),Xy("Auth",!0)):DA()}function r0(i){const e=i.indexOf(":");return e<0?"":i.substr(0,e+1)}function NA(i){const e=r0(i),t=/(\/\/)?([^?#/]+)/.exec(i.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",o=/^(\[[^\]]+\])(:|$)/.exec(s);if(o){const u=o[1];return{host:u,port:Ny(s.substr(u.length+1))}}else{const[u,h]=s.split(":");return{host:u,port:Ny(h)}}}function Ny(i){if(!i)return null;const e=Number(i);return isNaN(e)?null:e}function DA(){function i(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",i):i())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const GC="__/auth/handler",KC="emulator/auth/handler",QC=encodeURIComponent("fac");async function jy(i,e,t,s,o,u){ye(i.config.authDomain,i,"auth-domain-config-required"),ye(i.config.apiKey,i,"invalid-api-key");const h={apiKey:i.config.apiKey,appName:i.name,authType:t,redirectUrl:s,v:Do,eventId:o};if(e instanceof i0){e.setDefaultLanguage(i.languageCode),h.providerId=e.providerId||"",wE(e.getCustomParameters())||(h.customParameters=JSON.stringify(e.getCustomParameters()));for(const[E,C]of Object.entries({}))h[E]=C}if(e instanceof cl){const E=e.getScopes().filter(C=>C!=="");E.length>0&&(h.scopes=E.join(","))}i.tenantId&&(h.tid=i.tenantId);const m=h;for(const E of Object.keys(m))m[E]===void 0&&delete m[E];const y=await i._getAppCheckToken(),_=y?`#${QC}=${encodeURIComponent(y)}`:"";return`${YC(i)}?${nl(m).slice(1)}${_}`}function YC({config:i}){return i.emulator?jf(i,KC):`https://${i.authDomain}/${GC}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`).filter(Ke=>Ke.trim()),delete me.detailsStr),b&&b.type===$?(await qS(go(Yt,`${$}s`,b.id),me),alert("수정 완료!")):(await co(ar(Yt,`${$}s`),me),alert("추가 완료!"))),O(),De()}catch(me){console.error("Error saving document: ",me),alert("저장 중 오류가 발생했습니다")}},gt=async($,me)=>{if(window.confirm("정말 삭제하시겠습니까?"))try{await HS(go(Yt,`${$}s`,me)),alert("삭제 완료!"),O()}catch(Ke){console.error("Error deleting document: ",Ke),alert("삭제 중 오류가 발생했습니다")}},Rn=$=>{const me=document.getElementById($);me&&(me.scrollIntoView({behavior:"smooth"}),e($),s(!1))},kn=$=>{const me=b&&b.type===$,Ke=T.jsxs("div",{className:"space-y-4",children:[T.jsxs("div",{className:"flex items-center justify-between mb-4",children:[T.jsx("h4",{className:"text-xl font-bold text-white",children:$==="profile"?"프로필 수정":me?"수정하기":"새로 추가하기"}),Z&&T.jsx("button",{onClick:De,className:"p-2 text-slate-400 hover:text-white",children:T.jsx(cd,{size:24})})]}),$==="profile"&&T.jsxs(T.Fragment,{children:[T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"첫 번째 문단"}),T.jsx("textarea",{className:"input-field-mobile min-h-[100px]",placeholder:"I work across content strategy...",value:ce.summary1||"",onChange:Ee=>ge({...ce,summary1:Ee.target.value})})]}),T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"두 번째 문단"}),T.jsx("textarea",{className:"input-field-mobile min-h-[100px]",placeholder:"Currently, I am expanding my expertise...",value:ce.summary2||"",onChange:Ee=>ge({...ce,summary2:Ee.target.value})})]})]}),$==="project"&&T.jsxs(T.Fragment,{children:[T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"프로젝트 제목"}),T.jsx("input",{className:"input-field-mobile",placeholder:"예: 크래프톤 팟캐스트 기획",value:ce.title||"",onChange:Ee=>ge({...ce,title:Ee.target.value})})]}),T.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"타입"}),T.jsxs("select",{className:"input-field-mobile",value:ce.type||"blog",onChange:Ee=>ge({...ce,type:Ee.target.value}),children:[T.jsx("option",{value:"blog",children:"블로그"}),T.jsx("option",{value:"video",children:"비디오"}),T.jsx("option",{value:"podcast",children:"팟캐스트"})]})]}),T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"링크 텍스트"}),T.jsx("input",{className:"input-field-mobile",placeholder:"View Blog",value:ce.linkText||"",onChange:Ee=>ge({...ce,linkText:Ee.target.value})})]})]}),T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"설명"}),T.jsx("textarea",{className:"input-field-mobile min-h-[100px]",placeholder:"프로젝트 설명을 입력하세요",value:ce.description||"",onChange:Ee=>ge({...ce,description:Ee.target.value})})]}),ce.type==="video"?T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"YouTube 비디오 ID"}),T.jsx("input",{className:"input-field-mobile",placeholder:"dQw4w9WgXcQ",value:ce.videoId||"",onChange:Ee=>ge({...ce,videoId:Ee.target.value})})]}):T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"링크 URL"}),T.jsx("input",{className:"input-field-mobile",placeholder:"https://...",value:ce.link||"",onChange:Ee=>ge({...ce,link:Ee.target.value})})]})]}),$==="experience"&&T.jsxs(T.Fragment,{children:[T.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"직책/역할"}),T.jsx("input",{className:"input-field-mobile",placeholder:"예: Podcast Producer",value:ce.role||"",onChange:Ee=>ge({...ce,role:Ee.target.value})})]}),T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"회사명"}),T.jsx("input",{className:"input-field-mobile",placeholder:"예: Krafton",value:ce.company||"",onChange:Ee=>ge({...ce,company:Ee.target.value})})]})]}),T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"기간"}),T.jsx("input",{className:"input-field-mobile",placeholder:"예: 2022 - 2024",value:ce.period||"",onChange:Ee=>ge({...ce,period:Ee.target.value})})]}),T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"주요 업무 (한 줄에 하나씩)"}),T.jsx("textarea",{className:"input-field-mobile min-h-[150px]",placeholder:`첫 번째 업무
두 번째 업무
세 번째 업무`,value:ce.detailsStr||"",onChange:Ee=>ge({...ce,detailsStr:Ee.target.value})})]})]}),$==="education"&&T.jsxs(T.Fragment,{children:[T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"학교명"}),T.jsx("input",{className:"input-field-mobile",placeholder:"예: 연세대학교",value:ce.school||"",onChange:Ee=>ge({...ce,school:Ee.target.value})})]}),T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"학위/전공"}),T.jsx("input",{className:"input-field-mobile",placeholder:"예: M.A. Digital Innovation",value:ce.degree||"",onChange:Ee=>ge({...ce,degree:Ee.target.value})})]}),T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"기간/위치"}),T.jsx("input",{className:"input-field-mobile",placeholder:"예: 2024 - 2027 | Seoul",value:ce.period||"",onChange:Ee=>ge({...ce,period:Ee.target.value})})]}),T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"설명"}),T.jsx("textarea",{className:"input-field-mobile min-h-[100px]",placeholder:"Focus: AI, Data Analytics",value:ce.description||"",onChange:Ee=>ge({...ce,description:Ee.target.value})})]})]}),$==="skill"&&T.jsxs(T.Fragment,{children:[T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"카테고리"}),T.jsx("input",{className:"input-field-mobile",placeholder:"예: Strategy & Data",value:ce.category||"",onChange:Ee=>ge({...ce,category:Ee.target.value})})]}),T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-300 mb-2 font-medium",children:"스킬 (쉼표로 구분)"}),T.jsx("textarea",{className:"input-field-mobile min-h-[100px]",placeholder:"Python, SQL, Excel, Power BI",value:ce.items||"",onChange:Ee=>ge({...ce,items:Ee.target.value})})]})]}),T.jsxs("div",{className:"flex gap-3 mt-6",children:[T.jsxs("button",{onClick:()=>We($),className:"btn-primary-mobile flex-1 flex items-center justify-center gap-2",children:[T.jsx(Gw,{size:20})," 저장하기"]}),!Z&&T.jsxs("button",{onClick:De,className:"btn-secondary-mobile flex items-center justify-center gap-2",children:[T.jsx(Ww,{size:20})," 취소"]})]})]});return Z?T.jsx("div",{className:"fixed inset-0 bg-slate-900 z-[200] overflow-y-auto",children:T.jsx("div",{className:"min-h-screen p-6 pb-24",children:Ke})}):T.jsx("div",{ref:ne,className:"bg-slate-800 p-6 rounded-xl border border-slate-600 mb-6 animate-fade-in-up",children:Ke})};return T.jsxs("div",{className:"min-h-screen bg-slate-900 text-slate-300 font-sans selection:bg-indigo-500 selection:text-white relative",children:[T.jsxs("div",{className:"fixed bottom-6 right-6 z-[100] flex flex-col gap-3",children:[ae&&T.jsx("button",{onClick:Se,className:"p-4 bg-green-600 text-white rounded-full shadow-lg hover:bg-green-700 transition-all",title:"데이터 마이그레이션",children:T.jsx(jw,{size:24})}),ae?T.jsxs("div",{className:"flex gap-2 items-center",children:[T.jsx("span",{className:"bg-indigo-600 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg",children:"관리자"}),T.jsx("button",{onClick:Ie,className:"p-4 bg-red-600 text-white rounded-full shadow-lg hover:bg-red-700 transition-all flex items-center justify-center",title:"로그아웃",children:T.jsx(Bw,{size:24})})]}):T.jsx("button",{onClick:()=>qe(!Pe),className:"p-4 bg-slate-800 rounded-full shadow-lg border border-slate-700 hover:bg-slate-700 transition-all opacity-50 hover:opacity-100 flex items-center justify-center",title:"관리자 로그인",children:T.jsx(zw,{size:24,className:"text-slate-400"})})]}),Pe&&!ae&&T.jsx("div",{className:"fixed inset-0 bg-black/90 z-[101] flex items-center justify-center p-4",children:T.jsxs("div",{className:"bg-slate-800 p-8 rounded-2xl w-full max-w-md border border-slate-700 shadow-2xl",children:[T.jsxs("div",{className:"flex justify-between items-center mb-6",children:[T.jsx("h2",{className:"text-2xl font-bold text-white",children:"관리자 로그인"}),T.jsx("button",{onClick:()=>qe(!1),children:T.jsx(cd,{className:"text-slate-400 hover:text-white",size:24})})]}),T.jsxs("form",{onSubmit:H,className:"space-y-4",children:[T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-400 mb-2",children:"이메일"}),T.jsx("input",{type:"email",value:Ne,onChange:$=>P($.target.value),className:"input-field-mobile",placeholder:"admin@example.com"})]}),T.jsxs("div",{children:[T.jsx("label",{className:"block text-sm text-slate-400 mb-2",children:"비밀번호"}),T.jsx("input",{type:"password",value:S,onChange:$=>R($.target.value),className:"input-field-mobile",placeholder:"비밀번호"})]}),V&&T.jsx("p",{className:"text-red-400 text-sm",children:V}),T.jsx("button",{type:"submit",className:"w-full bg-indigo-600 text-white py-4 rounded-lg font-bold hover:bg-indigo-700 transition-colors text-lg",children:"로그인"})]})]})}),T.jsxs("nav",{className:`fixed w-full z-40 transition-all duration-300 ${o?"bg-slate-900/95 backdrop-blur-md shadow-lg border-b border-slate-800":"bg-transparent"}`,children:[T.jsxs("div",{className:"max-w-6xl mx-auto px-6 py-4 flex justify-between items-center",children:[T.jsxs("div",{onClick:()=>Rn("home"),className:"text-2xl font-bold text-slate-100 cursor-pointer hover:text-indigo-400 transition-colors",children:["HK",T.jsx("span",{className:"text-indigo-500",children:"."})]}),T.jsx("div",{className:"hidden md:flex space-x-8",children:["About","Experience","Projects","Skills","Contact"].map($=>T.jsx("button",{onClick:()=>Rn($.toLowerCase()),className:"text-sm font-medium hover:text-indigo-400 transition-colors",children:$},$))}),T.jsx("div",{className:"md:hidden",children:T.jsx("button",{onClick:()=>s(!t),className:"text-slate-100 focus:outline-none p-2",children:t?T.jsx(cd,{size:28}):T.jsx($w,{size:28})})})]}),t&&T.jsx("div",{className:"md:hidden bg-slate-800 border-b border-slate-700",children:T.jsx("div",{className:"px-6 py-4 flex flex-col space-y-4",children:["About","Experience","Projects","Skills","Contact"].map($=>T.jsx("button",{onClick:()=>Rn($.toLowerCase()),className:"text-left text-base font-medium hover:text-indigo-400 transition-colors py-2",children:$},$))})})]}),T.jsxs("section",{id:"home",className:"min-h-screen flex items-center justify-center pt-20 px-6 relative overflow-hidden",children:[T.jsx("div",{className:"absolute top-20 left-10 w-72 h-72 bg-indigo-600/20 rounded-full blur-[100px] pointer-events-none"}),T.jsx("div",{className:"absolute bottom-20 right-10 w-96 h-96 bg-blue-600/10 rounded-full blur-[100px] pointer-events-none"}),T.jsxs("div",{className:"max-w-4xl mx-auto text-center relative z-10",children:[T.jsx("h2",{className:"text-indigo-400 font-medium tracking-wider mb-4 animate-fade-in-up",children:"CONTENT STRATEGIST & PRODUCER"}),T.jsx("h1",{className:"text-5xl md:text-7xl font-bold text-slate-100 mb-6 leading-tight animate-fade-in-up delay-100",children:"Hyeongmo Kim"}),T.jsxs("p",{className:"text-xl md:text-2xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed animate-fade-in-up delay-200",children:["Connecting creative work with data and tight execution.",T.jsx("br",{}),"Focusing on audience behavior, AI, and data-driven decision-making."]}),T.jsxs("div",{className:"flex flex-col sm:flex-row justify-center gap-4 animate-fade-in-up delay-300",children:[T.jsxs("button",{onClick:()=>Rn("contact"),className:"px-8 py-4 bg-indigo-600 text-white rounded-full font-medium hover:bg-indigo-700 transition-all hover:scale-105 flex items-center justify-center gap-2 text-lg",children:[T.jsx(cg,{size:20})," Get in Touch"]}),T.jsxs("a",{href:"https://www.linkedin.com/in/hmstory0111",target:"_blank",rel:"noreferrer",className:"px-8 py-4 bg-slate-800 text-slate-200 rounded-full font-medium hover:bg-slate-700 transition-all hover:scale-105 flex items-center justify-center gap-2 border border-slate-700 text-lg",children:[T.jsx(Uw,{size:20})," LinkedIn"]})]})]})]}),T.jsx("section",{id:"about",className:"py-20 px-6 bg-slate-800/50",children:T.jsxs("div",{className:"max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-start",children:[T.jsxs("div",{className:"relative group",children:[T.jsxs("div",{className:"flex items-center justify-between mb-6",children:[T.jsxs("h2",{className:"text-3xl font-bold text-slate-100 flex items-center gap-3",children:[T.jsx("span",{className:"w-12 h-1 bg-indigo-500 rounded-full"}),"Professional Summary"]}),ae&&T.jsx("button",{onClick:()=>be("profile",Y||{summary1:"",summary2:""}),className:"opacity-0 group-hover:opacity-100 p-2 bg-indigo-600 rounded-full text-white hover:bg-indigo-700 transition-all",children:T.jsx(Da,{size:18})})]}),(b==null?void 0:b.type)==="profile"&&kn("profile"),Y?T.jsxs(T.Fragment,{children:[T.jsx("p",{className:"text-lg text-slate-400 leading-relaxed mb-6",children:Y.summary1}),T.jsx("p",{className:"text-lg text-slate-400 leading-relaxed",children:Y.summary2})]}):T.jsxs(T.Fragment,{children:[T.jsx("p",{className:"text-lg text-slate-400 leading-relaxed mb-6",children:"I work across content strategy, production, and operations. My passion lies in bridging the gap between creative storytelling and analytical rigor."}),T.jsxs("p",{className:"text-lg text-slate-400 leading-relaxed",children:["Currently, I am expanding my expertise by pursuing an ",T.jsx("strong",{className:"text-slate-200",children:"M.A. in Digital Innovation"}),", specifically studying how AI and data can inform audience behavior analysis and decision-making processes."]})]})]}),T.jsxs("div",{className:"bg-slate-900 p-8 rounded-2xl border border-slate-700 shadow-xl relative",children:[T.jsxs("div",{className:"flex items-center justify-between mb-6",children:[T.jsxs("div",{className:"flex items-center gap-3 text-indigo-400",children:[T.jsx(lg,{size:24}),T.jsx("h3",{className:"text-xl font-bold",children:"Education"})]}),ae&&T.jsx("button",{onClick:()=>ke("education"),className:"p-3 bg-indigo-600 rounded-full text-white hover:bg-indigo-700 transition-all",children:T.jsx(Ru,{size:20})})]}),(Ue==="education"||(b==null?void 0:b.type)==="education")&&kn("education"),T.jsx("div",{className:"space-y-8",children:E.length>0?E.map($=>T.jsxs("div",{className:"relative pl-6 border-l-2 border-slate-700 group",children:[T.jsx("div",{className:"absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-slate-600"}),ae&&T.jsxs("div",{className:"absolute right-0 top-0 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity",children:[T.jsx("button",{onClick:()=>be("education",$),className:"p-2 bg-indigo-600/90 rounded-full hover:bg-indigo-600",children:T.jsx(Da,{size:16,className:"text-white"})}),T.jsx("button",{onClick:()=>gt("education",$.id),className:"p-2 bg-red-600/90 rounded-full hover:bg-red-600",children:T.jsx(ku,{size:16,className:"text-white"})})]}),T.jsx("h4",{className:"text-lg font-bold text-slate-100",children:$.school}),T.jsxs("p",{className:"text-indigo-400 text-sm mb-2",children:[$.degree," | ",$.period]}),T.jsx("p",{className:"text-slate-400 text-sm",children:$.description})]},$.id)):T.jsxs(T.Fragment,{children:[T.jsxs("div",{className:"relative pl-6 border-l-2 border-indigo-900",children:[T.jsx("div",{className:"absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-indigo-500"}),T.jsx("h4",{className:"text-lg font-bold text-slate-100",children:"Yonsei University - Graduate School"}),T.jsx("p",{className:"text-indigo-400 text-sm mb-2",children:"M.A. Digital Innovation (Expected 2027) | Seoul, Korea"}),T.jsx("p",{className:"text-slate-400 text-sm",children:"Focus: Audience Behavior, AI Data-driven decision-making"})]}),T.jsxs("div",{className:"relative pl-6 border-l-2 border-slate-700",children:[T.jsx("div",{className:"absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-slate-600"}),T.jsx("h4",{className:"text-lg font-bold text-slate-100",children:"Yonsei University"}),T.jsx("p",{className:"text-slate-400 text-sm mb-1",children:"B.A. International Relations & Psychology | 2005 - 2013"})]}),ae&&T.jsx("div",{className:"text-center mt-4 text-sm text-slate-500",children:"* 관리자: 녹색 버튼으로 데이터 마이그레이션 하세요"})]})})]})]})}),T.jsx("section",{id:"experience",className:"py-20 px-6",children:T.jsxs("div",{className:"max-w-4xl mx-auto",children:[T.jsxs("div",{className:"flex items-center justify-center gap-4 mb-12 relative",children:[T.jsx("h2",{className:"text-3xl font-bold text-slate-100 text-center",children:"Professional Experience"}),ae&&T.jsx("button",{onClick:()=>ke("experience"),className:"absolute right-0 p-3 bg-indigo-600 rounded-full text-white hover:bg-indigo-700 transition-all shadow-lg",children:T.jsx(Ru,{size:24})})]}),(Ue==="experience"||(b==null?void 0:b.type)==="experience")&&kn("experience"),T.jsx("div",{className:"space-y-12",children:y.length>0?y.map($=>T.jsxs("div",{className:"group relative bg-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-indigo-500/50 transition-all",children:[ae&&T.jsxs("div",{className:"absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity",children:[T.jsx("button",{onClick:()=>be("experience",$),className:"p-3 bg-indigo-600/90 rounded-full text-white hover:bg-indigo-600",children:T.jsx(Da,{size:18})}),T.jsx("button",{onClick:()=>gt("experience",$.id),className:"p-3 bg-red-600/90 rounded-full text-white hover:bg-red-600",children:T.jsx(ku,{size:18})})]}),T.jsxs("div",{className:"flex flex-col md:flex-row justify-between items-start mb-4",children:[T.jsxs("div",{children:[T.jsx("h3",{className:"text-xl font-bold text-slate-100",children:$.role}),T.jsx("p",{className:"text-slate-400",children:$.company})]}),T.jsx("span",{className:"px-3 py-1 bg-indigo-900/30 text-indigo-300 text-xs rounded-full border border-indigo-500/30",children:$.period})]}),T.jsx("ul",{className:"space-y-3 text-slate-400",children:$.details&&$.details.map((me,Ke)=>T.jsxs("li",{className:"flex items-start gap-3",children:[T.jsx(ud,{size:16,className:"mt-1 text-indigo-500 flex-shrink-0"}),T.jsx("span",{children:me})]},Ke))})]},$.id)):T.jsxs("div",{className:"group relative bg-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-indigo-500/50 transition-all",children:[T.jsxs("div",{className:"flex flex-col md:flex-row justify-between items-start mb-4",children:[T.jsxs("div",{children:[T.jsx("h3",{className:"text-xl font-bold text-slate-100",children:"Podcast & Video Producer"}),T.jsx("p",{className:"text-slate-400",children:"Krafton - Publishing Platform Division (PPD)"})]}),T.jsx("span",{className:"px-3 py-1 bg-indigo-900/30 text-indigo-300 text-xs rounded-full border border-indigo-500/30",children:"2025 - Present"})]}),T.jsxs("ul",{className:"space-y-3 text-slate-400",children:[T.jsxs("li",{className:"flex items-start gap-3",children:[T.jsx(ud,{size:16,className:"mt-1 text-indigo-500 flex-shrink-0"}),T.jsx("span",{children:"Produced internal podcasts and videos for 200+ staff."})]}),T.jsxs("li",{className:"flex items-start gap-3",children:[T.jsx(ud,{size:16,className:"mt-1 text-indigo-500 flex-shrink-0"}),T.jsx("span",{children:"Handled full production cycle (script, host, record, edit)."})]})]}),ae&&T.jsx("div",{className:"text-center mt-4 text-sm text-slate-500",children:"* 관리자: 녹색 버튼으로 데이터 마이그레이션 하세요"})]})})]})}),T.jsx("section",{id:"projects",className:"py-20 px-6 bg-slate-800/30",children:T.jsxs("div",{className:"max-w-6xl mx-auto",children:[T.jsxs("div",{className:"flex items-center gap-3 mb-12 relative",children:[T.jsxs("h2",{className:"text-3xl font-bold text-slate-100 flex items-center gap-3",children:[T.jsx("span",{className:"w-12 h-1 bg-indigo-500 rounded-full"}),"Selected Works"]}),ae&&T.jsx("button",{onClick:()=>ke("project"),className:"p-3 bg-indigo-600 rounded-full text-white hover:bg-indigo-700 ml-4 transition-all shadow-lg",children:T.jsx(Ru,{size:24})})]}),(Ue==="project"||(b==null?void 0:b.type)==="project")&&kn("project"),T.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-8",children:h.map($=>T.jsxs("div",{className:"bg-slate-900 rounded-xl overflow-hidden border border-slate-700 hover:border-indigo-500 transition-all group relative",children:[ae&&T.jsxs("div",{className:"absolute top-3 right-3 z-20 flex gap-2",children:[T.jsx("button",{onClick:()=>be("project",$),className:"p-3 bg-indigo-600/90 rounded-full text-white hover:bg-indigo-600 shadow-lg",children:T.jsx(Da,{size:18})}),T.jsx("button",{onClick:()=>gt("project",$.id),className:"p-3 bg-red-600/90 rounded-full text-white hover:bg-red-600 shadow-lg",children:T.jsx(ku,{size:18})})]}),T.jsx("div",{className:"h-48 bg-slate-800 flex items-center justify-center border-b border-slate-700 relative overflow-hidden",children:$.type==="video"&&$.videoId?T.jsx("img",{src:`https://img.youtube.com/vi/${$.videoId}/hqdefault.jpg`,alt:$.title,className:"w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity"}):T.jsxs(T.Fragment,{children:[T.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-indigo-900/20 to-slate-900"}),$.type==="podcast"?T.jsx(qw,{size:48,className:"text-slate-600 group-hover:text-purple-400 z-10"}):T.jsx(lg,{size:48,className:"text-slate-600 group-hover:text-indigo-400 z-10"})]})}),T.jsxs("div",{className:"p-8",children:[T.jsx("h3",{className:"text-xl font-bold text-slate-100 mb-2",children:$.title}),T.jsx("p",{className:"text-slate-400 mb-6 text-sm line-clamp-3",children:$.description}),T.jsxs("a",{href:$.type==="video"?`https://youtu.be/${$.videoId}`:$.link,target:"_blank",rel:"noreferrer",className:`font-medium flex items-center gap-2 transition-colors ${$.type==="video"?"text-red-400 hover:text-red-300":$.type==="podcast"?"text-purple-400 hover:text-purple-300":"text-indigo-400 hover:text-indigo-300"}`,children:[$.linkText||"View Detail",$.type==="video"?T.jsx(Hw,{size:16}):T.jsx(Fw,{size:16})]})]})]},$.id))})]})}),T.jsx("section",{id:"skills",className:"py-20 px-6",children:T.jsxs("div",{className:"max-w-4xl mx-auto",children:[T.jsxs("div",{className:"flex items-center justify-center gap-4 mb-12 relative",children:[T.jsx("h2",{className:"text-3xl font-bold text-slate-100 text-center",children:"Skills & Expertise"}),ae&&T.jsx("button",{onClick:()=>ke("skill"),className:"absolute right-0 p-3 bg-indigo-600 rounded-full text-white hover:bg-indigo-700 transition-all shadow-lg",children:T.jsx(Ru,{size:24})})]}),(Ue==="skill"||(b==null?void 0:b.type)==="skill")&&kn("skill"),T.jsx("div",{className:"grid md:grid-cols-2 gap-8",children:x.length>0?x.map($=>T.jsxs("div",{className:"relative group",children:[ae&&T.jsxs("div",{className:"absolute -top-3 -right-3 z-20 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity",children:[T.jsx("button",{onClick:()=>be("skill",$),className:"p-2 bg-indigo-600/90 rounded-full text-white hover:bg-indigo-600",children:T.jsx(Da,{size:16})}),T.jsx("button",{onClick:()=>gt("skill",$.id),className:"p-2 bg-red-600/90 rounded-full text-white hover:bg-red-600",children:T.jsx(ku,{size:16})})]}),T.jsxs("div",{className:"flex items-center gap-3 mb-6",children:[T.jsx(ug,{className:"text-indigo-500"}),T.jsx("h3",{className:"text-xl font-bold text-slate-200",children:$.category})]}),T.jsx("div",{className:"flex flex-wrap gap-3",children:$.items&&$.items.map((me,Ke)=>T.jsx("span",{className:"px-4 py-2 bg-slate-800 text-slate-300 rounded-lg text-sm border border-slate-700",children:me},Ke))})]},$.id)):T.jsxs(T.Fragment,{children:[T.jsxs("div",{children:[T.jsxs("div",{className:"flex items-center gap-3 mb-6",children:[T.jsx(ug,{className:"text-indigo-500"}),T.jsx("h3",{className:"text-xl font-bold text-slate-200",children:"Strategy & Data"})]}),T.jsx("div",{className:"flex flex-wrap gap-3",children:["Audience Insights","Content Analytics","Roadmapping"].map($=>T.jsx("span",{className:"px-4 py-2 bg-slate-800 text-slate-300 rounded-lg text-sm border border-slate-700",children:$},$))})]}),T.jsxs("div",{children:[T.jsxs("div",{className:"flex items-center gap-3 mb-6",children:[T.jsx(Kw,{className:"text-indigo-500"}),T.jsx("h3",{className:"text-xl font-bold text-slate-200",children:"Production & Tools"})]}),T.jsx("div",{className:"flex flex-wrap gap-3",children:["Pro Tools","Premiere Pro","Final Cut Pro","AI Editing Tools"].map($=>T.jsx("span",{className:"px-4 py-2 bg-slate-800 text-slate-300 rounded-lg text-sm border border-slate-700",children:$},$))})]}),ae&&T.jsx("div",{className:"text-center mt-4 text-sm text-slate-500 col-span-2",children:"* 관리자: 녹색 버튼으로 데이터 마이그레이션 하세요"})]})})]})}),T.jsx("section",{id:"contact",className:"py-20 px-6 bg-indigo-900/20",children:T.jsxs("div",{className:"max-w-4xl mx-auto text-center",children:[T.jsx("h2",{className:"text-3xl font-bold text-slate-100 mb-6",children:"Let's Connect"}),T.jsx("div",{className:"flex flex-col md:flex-row justify-center gap-6",children:T.jsxs("a",{href:"mailto:hmstory0111@gmail.com",className:"flex items-center justify-center gap-3 px-8 py-4 bg-slate-800 text-slate-200 rounded-xl hover:bg-slate-700 transition-colors border border-slate-700",children:[T.jsx(cg,{size:20,className:"text-indigo-400"}),"hmstory0111@gmail.com"]})}),T.jsx("div",{className:"mt-20 pt-10 border-t border-slate-800 text-slate-500 text-sm",children:T.jsx("p",{children:"© 2025 Hyeongmo Kim. All rights reserved. (Full Admin Version)"})})]})}),T.jsx("style",{children:`
      ...
      `})]})};bw.createRoot(document.getElementById("root")).render(T.jsx(Rw.StrictMode,{children:T.jsx(lR,{})}));
